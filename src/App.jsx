    ...
    <>
      ...
      <main id="top">
        ...
        <section className="specialists section">
          <div className="specialists-heading"><p className="eyebrow">Specialist service areas</p><h2>More than a quick fix.<br /><i>A complete view.</i></h2></div>
          <div className="specialists-copy"><p>Automotive Expert brings routine maintenance, auto repair, tyres, wheel alignment and balancing, diagnostics, fluids, climate systems, suspension, steering and drivetrain care into one clear conversation.</p><a className="text-link" href="#booking">Book a vehicle assessment <Icon name="arrow" /></a></div>
        </section>

        <section className="insights section">
          <div className="insight-image"><img src="/assets/wamuco-tyre-guide.png" alt="Tyre being fitted to a wheel" /></div>
          <div className="insight-copy"><p className="eyebrow">Road-ready care</p><h2>Small checks.<br /><i>Safer journeys.</i></h2><p>Tyres, filters, fluids and service intervals all shape how your vehicle feels on the road. Bring us the concern early and we’ll help you understand the next practical step.</p><a className="text-link" href="#booking">Book a check-up <Icon name="arrow" /></a></div>
        </section>
